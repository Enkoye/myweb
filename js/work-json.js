	...
	function loadBlog(work){
	    ...
	    for (var i = 0; i < work.length; i++) {
	    	...
	    	for (var k = 0; k < lengthIcoFont[i]; k++) {
	    		icoFont[i] += "<li><i class=\"" + work[i].icoFont[k] + "\"></i><div><p>" + work[i].features[k] + "</p></div><p>" + work[i].featureValue[k] + "</p></li>";
	    	}
							...
							"<div class=\"contentWork\">" +
								"<div class=\"work-project\">" +
									"<div class=\"columnProject1\">" +
										...
										"<div class=\"wrapper-img-popWork\">" +
											"<img data-src= '" + work[i].image + "' alt= '" + work[i].alt + "' class='lazyload'>" +
										"</div>" +
										"<ul>" +
											icoFont[i] +
										"</ul>" +
								...
								"<div class=\"columnButtons1\">" +
						            "<div class=\"button-row\">" +
						            	"<div><a href=\"" + work[i].href + "\" title=\"VISIT\"></a></div>" +
						           	"</div>" +
							    "</div>" +
							    "<div class=\"columnButtons2\">" +
							    	"<div class=\"button-row prev\">" + 
										"<div><a title=\"PREV\"></a></div>" +
									"</div>" +
									"<div class=\"button-row next\">" +
										"<div><a title=\"NEXT\"></a></div>" +
									"</div>" +
							    "</div>" +
							"</div>" +
